...
#include <cstdlib>
#include <iostream>
#include "E:\學校資料(新)\進階C語言實務\HW3\include\BVH.h"
#include "E:\學校資料(新)\進階C語言實務\HW3\include\Sphere.h"
#include "E:\學校資料(新)\進階C語言實務\HW3\include\Vector3.h"
...
int main(int argc, char **argv) {
	...
	Vector3 camera_position(4.0, 3.0, 4.0);
    ...
    FILE* image = fopen("E:\\學校資料(新)\\進階C語言實務\\HW3\\Project3\\render.ppm", "w");
    if (image == nullptr) {
